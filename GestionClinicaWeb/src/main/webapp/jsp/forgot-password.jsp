				...
				<div class="card border-0 shadow-lg my-5">
					<div class="card-body p-5">
						<div class="text-center">
							<h1 class="h4 text-gray-900 mb-2">¿Has olvidado tu
								contraseña?</h1>
							<p class="mb-4">No te preocupes, estas cosas pasan. Introduce
								tu email y te enviaremos un enlace para restablecer tu
								contraseña.</p>
						</div>
						<form class="user" method="post" id="forgot"
							action="/clinicaweb/Forgot">
							...
							<a
								onclick="document.getElementById('forgot').submit(); return false;"
								class="btn btn-primary btn-user btn-block">Restablecer
								contraseña</a>
							<%
