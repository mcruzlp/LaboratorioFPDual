			...
			<div id="content">
				...
				<div class="container-fluid">
					...
					<div
						...
						<h1 class="h3 mb-0 text-gray-800">Planificación</h1>
						<a href="#"
								...
								<div class="card-body">
									<div class="row no-gutters align-items-center">
										<div class="col mr-2">
											...
											<div class="h5 mb-0 font-weight-bold text-gray-800">24.000
												€</div>
										</div>
										<div class="col-auto">
									...
									<div class="dropdown no-arrow">
										...
										<div
											...
											<a class="dropdown-item"
												href="https://calendar.google.com/calendar/u/0/r?tab=wc"
												target="_blank">Abrir calendario</a>
										</div>
									</div>
								</div>
								<!-- Card Body -->
