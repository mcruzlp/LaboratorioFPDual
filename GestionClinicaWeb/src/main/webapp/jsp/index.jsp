							...
							<div class="form-group">
								<div class="custom-control custom-checkbox small">
									<input type="checkbox" class="custom-control-input"
										...
										for="customCheck">Recordar mis datos</label>
								</div>
							</div>
							<a href="landing.jsp" class="btn btn-primary btn-user btn-block">Entrar</a>
						</form>
						<hr>
						<div class="text-center">
							<a class="small" href="register.jsp">Crear usuario
								nuevo</a>
						</div>
						<div class="text-center">
							<a class="small" href="forgot-password.jsp">¿Has
