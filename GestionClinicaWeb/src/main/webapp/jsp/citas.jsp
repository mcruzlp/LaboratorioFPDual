...
<%@page import="edu.laboratoriofpdual.dao.Cita"%>
<%@page import="edu.laboratoriofpdual.manager.CitasManager"%>
...
<link rel="shortcut icon" href="/clinicaweb/images/favicon.png"
		type="image/x-icon">
<title>Clinica Nilo - Citas</title>
...
<body id="page-top">
		...
		<div id="wrapper">
              ...
              <button class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm dt-button buttons-create"
                data-toggle="modal" data-target="#myModal1" tabindex="0" aria-controls="dataTable"
                type="button"><span>Nueva</span></button>
              <button
																...
																<div class="modal-dialog">
																		<div class="modal-content justify-content-center">
																				...
																				<div class="modal-header">
																						<h1 class="modal-title">Nueva cita</h1>
																						<button type="button" class="close" data-dismiss="modal">×</button>
																				</div>
																				<!-- Modal body -->
																				<div class="modal-body">
																						<form class="container m-2" method="post" id="nuevacita"
																								action="/clinicaweb/NuevaCita">
																								<div class="form-row">
																										<div class="form-group col-12">
																												<label for="inputName">Paciente</label> <input
																								...
																								<div class="form-row">
																										<div class="form-group col-md-6">
																												<label for="inputDate">Fecha</label> <input
																														type="date" id="fechacita" name="codCita">
																										</div>
																										<div class="form-group col-md-6">
																												<label for="inputHour">Hora</label> <select
																														id="inputHour" class="form-control"
																														name="horaCita">
																				...
																				<div class="modal-footer">
																						<button type="button" onclick="document.getElementById('nuevacita').submit();"
														...
														<div class="modal" id="myModal2">
																<div class="modal-dialog">
																		<div class="modal-content justify-content-center">
																				...
																				<!-- Modal body -->
																				<div class="modal-body">
																						<form class="container m-2" method="post" id="modificacita"
                                                action="/clinicaweb/ModificaCita">
																								<div class="form-row">
																										<div class="form-group col-12">
																												<label for="inputName">Nombre</label> <input
																														type="text" class="form-control" id="inputName"  name="nomPac">
																										</div>
																								</div>
																								<div class="form-row">
																										<div class="form-group col-md-6">
																										...
																										<div class="form-group col-md-6">
																												<label for="inputHour">Hora</label> <select
																														id="inputHour" class="form-control" name="horaCita">
																														<option selected>Elige...</option>
																														<option>16:00</option>
																														<option>17:00</option>
																														<option>18:00</option>
																				...
																				<!-- Modal footer -->
																				<div class="modal-footer">
																						<button type="button" onclick="document.getElementById('modificacita').submit();"
																								class="btn btn-sm btn-primary shadow-sm"
														...
														<div class="modal" id="myModal3">
																<div class="modal-dialog">
																		<div class="modal-content justify-content-center">
																				<!-- Modal Header -->
																				<div class="modal-header">
																						<h1 class="modal-title">Anular cita</h1>
																						<button type="button" class="close" data-dismiss="modal">×</button>
																				</div>
																				<!-- Modal body -->
																				<div class="modal-body">
																						<form class="container m-2">
																								<div class="text-center">
																										<h1 class="h4 text-gray-900 mb-2">¿Estás segura
																												de que quieres anular esta cita?</h1>
																								</div>
																								<form class="container m-2" method="post" id="borracita"
                                                action="/clinicaweb/BorrarCita">
																										<div class="form-row">
																												<div class="form-group col-12">
																														<label for="inputName">Nombre</label> <input
																																type="text" class="form-control" id="inputName" name="nomPac">
																										...
																										<div class="form-row">
																												<div class="form-group col-md-6">
																														<label for="inputDate">Fecha</label> <input
																																type="text" class="form-control" id="inputDate" name="codCita">
																												</div>
																												<div class="form-group col-md-6">
																														<label for="inputHour">Hora</label> <input
																																type="text" class="form-control" id="inputHour" name="horaCita">
																												</div>
																										</div>
																								</form>
																						</form>
																				...
																				<!-- Modal footer -->
																				<div class="modal-footer">
																						<button type="button" onclick="document.getElementById('borracita').submit();"
																								class="btn btn-sm btn-primary shadow-sm"
																...
																%>
																<button type="button" class="btn" data-toggle="modal"
																		data-target="#myModal3">Anular</button>
														</div>
												</div>
												...
												<div class="m-2">
														<div class="table-responsive">
																<table
																		...
																		List<Cita> citas = new CitasManager().findAll(con);
																		%>
																		<tbody>
																				<%
																				for (Cita c : citas) {
		...
		<!-- Page level plugins -->
		<script src="/clinicaweb/vendor/citas/jquery.citastable.js"></script>
		<script src="/clinicaweb/vendor/citas/citas.bootstrap4.js"></script>
		<!-- Editor plugins -->
		<script
