											...
											<form class="container m-2">
												<div class="form-row">
													<div class="form-group col-4">
														<label for="inputCodPac">Nº usuario</label> <input
											...
											<form class="container m-2">
												<div class="text-center">
													<h1 class="h4 text-gray-900 mb-2">¿Estás segura de que
														quieres borrar los datos de este usuario?</h1>
												...
												<div class="form-row">
													<div class="form-group col-md-6">
														<label for="inputEsp">Especialidad</label> <input type="text"
															class="form-control" id="inputEsp">
													</div>
													<div class="form-group col-md-6">
