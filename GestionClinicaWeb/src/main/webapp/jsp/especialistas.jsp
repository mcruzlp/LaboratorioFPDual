...
<link rel="shortcut icon" href="/clinicaweb/images/favicon.png"
		type="image/x-icon">
<title>Clinica Nilo - Usuarios</title>
		...
		<div id="wrapper">
				...
				<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion"
						...
						<li class="nav-item"><a class="nav-link" href="pacientes.jsp"> <i
										class="fas fa-fw fa-address-book"></i> <span>Pacientes</span>
						</a></li>

						<li class="nav-item"><a class="nav-link" href="citas.jsp"> <iclass="fasfa-fwfa-calendar">
										</i> <span>Citas</span></a></li>
              ...
              <div class="input-group-append">
                <button class="btn btn-primary" type="button">
                  <i class="fas fa-search fa-sm"></i>
                       ...
                       <button class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm dt-button buttons-create" data-toggle="modal" data-target="#myModal1" tabindex="0" aria-controls="dataTable" type="button">
                          <span>Nuevo</span>
                       </button>
                       <button
                        ...
                        <button
                                ...
                                type="button"><span>Borrar</span>
														...
														<div class="modal-dialog">
																<div class="modal-content justify-content-center">
																		...
																		<div class="modal-body">
																				<form class="container m-2" method="post"
																						action="/clinicaweb/jsp/NuevoUsuario" id="creausuario">
																						<div class="form-row">
																								<label for="inputName">Nombre</label> <input type="text"
																										name="nomEsp" class="form-control" id="inputName">
																						</div>
																						<div class="form-row">
																								<label for="inputEsp">Especialidad</label> <input
																										name="especialidad" type="text" class="form-control" id="inputEsp">
																						</div>
																						<div class="form-row">
																								<div class="form-group col-md-6">
																										<label for="inputEmail">Email</label> <input
																												name="emailEsp" type="email" class="form-control" id="inputEmail">
																								</div>
																								<div class="form-group col-md-6">
																										<label for="inputTlfn">Teléfono</label> <input
																												name="tlfnEsp" type="tel" class="form-control" id="inputTlfn">
																								</div>
																						</div>
																				</form>
																		</div>
																		...
																		<div class="modal-footer">
																				<button type="button" onclick="document.getElementById('creausuario').submit();"
												...
												<div class="modal" id="myModal2">
														<div class="modal-dialog">
																<div class="modal-content justify-content-center">
																		...
																		<!-- Modal body -->
																		<div class="modal-body">
																				<form class="container m-2" method="post" id="modificausuario"
																						action="/clinicaweb/jsp/EditaUsuario">
																						<div class="form-row">
                                                <label for="inputName">Nombre</label> <input type="text"
                                                    name="nomEsp" class="form-control" id="inputName">
                                            </div>
                                                    ...
                                                    <label for="inputTlfn">Teléfono</label> <input
                                                        name="tlfnEsp" type="tel" class="form-control" id="inputTlfn">
																		...
																		<div class="modal-footer">
																				<button type="button"
																						class="btn btn-sm btn-primary shadow-sm"
																						onclick="document.getElementById('modificausuario').submit();"
												...
												<div class="modal" id="myModal3">
														<div class="modal-dialog">
																<div class="modal-content justify-content-center">
																		<!-- Modal Header -->
																		<div class="modal-header">
																				<h1 class="modal-title">Borrar usuario</h1>
																				<button type="button" class="close" data-dismiss="modal">×</button>
																		</div>
																		<!-- Modal body -->
																		<div class="modal-body">
																				<form class="container m-2" method="post" id="borrausuario"
																						action="/clinicaweb/jsp/BorraUsuario">
																						<div class="text-center">
																								<h1 class="h4 text-gray-900 mb-2">¿Estás segura de
																										que quieres borrar los datos de este usuario?</h1>
                                                ...
                                                <div class="form-group col-md-6">
                                                    <label for="inputTlfn">Teléfono</label> <input
                                                        name="tlfnEsp" type="tel" class="form-control" id="inputTlfn">
																		...
																		<div class="modal-footer">
																				<button type="button"
																				onclick="document.getElementById('borrausuario').submit();"
																						class="btn btn-sm btn-primary shadow-sm"
										...
										<!-- TODO quitar espacio extra sobre "mostrar usuarios" -->
										<div class="m-2">
												<div class="table-responsive">
														<table
																class="table table-striped table-bordered dataTable display"
																role="grid" id="usuarios" width="100%">
																<thead>
																		<tr>
																				<th></th>
																				<th>Nº</th>
																...
																List<Especialista> especialistas = new EspecialistasManager().findAll(con);
																%>
																<tbody>
																		<%
